---
title: Documentation for the salesforce-apex Generator
---
...
| -------- | ----- | ----- |
| generator name | salesforce-apex | pass this to the generate command after -g |
| generator stability | STABLE | |
| generator type | CLIENT | |
| generator language | Salesforce Apex | |
| generator default templating engine | mustache | |
| helpTxt | Generates a Salesforce Apex API client library. | |
