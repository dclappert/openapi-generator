...
public class SalesforceApexClientCodegenOptionsProvider implements OptionsProvider {
    ...
    public static final String OUTPUT_DIRECTORY_NAME = "latest";
    public static final String SALESFORCE_API_VERSION_VALUE = "67.0";
    ...
    public Map<String, String> createOptions() {
        return new ImmutableMap.Builder<String, String>()
                ...
                .put(SalesforceApexClientCodegen.API_VERSION, API_VERSION)
                ...
                .put(SalesforceApexClientCodegen.OUTPUT_DIRECTORY_NAME, OUTPUT_DIRECTORY_NAME)
